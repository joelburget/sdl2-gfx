...
foreign import ccall unsafe "hlineColor"
    gfxHLineColor :: Ptr RendererStruct
                  -> Int16
                  -> Int16
                  -> Int16
                  -> Word32
...
foreign import ccall unsafe "vlineColor"
    gfxVLineColor :: Ptr RendererStruct
                  -> Int16
                  -> Int16
                  -> Int16
                  -> Word32
...
foreign import ccall unsafe "rectangleColor"
    gfxRectangleColor :: Ptr RendererStruct
                      -> Int16
                      -> Int16
                      -> Int16
                      -> Int16
...
rectangle renderer (Rect x y w h) (Pixel c) = withForeignPtr renderer $ \ptr ->
    intToBool (-1) (fmap fromCInt $ gfxRectangleColor ptr
                                                      (fromIntegral x)
                                                      (fromIntegral y)
                                                      (fromIntegral w)
                                                      (fromIntegral h)
...
foreign import ccall unsafe "boxColor"
    gfxBoxColor :: Ptr RendererStruct
                -> Int16
                -> Int16
                -> Int16
                -> Int16
...
foreign import ccall unsafe "lineColor"
    gfxLineColor :: Ptr RendererStruct
                 -> Int16
                 -> Int16
                 -> Int16
                 -> Int16
...
foreign import ccall unsafe "aalineColor"
    gfxAALineColor :: Ptr RendererStruct
                   -> Int16
                   -> Int16
                   -> Int16
                   -> Int16
...
foreign import ccall unsafe "circleColor"
    gfxCircleColor :: Ptr RendererStruct
                   -> Int16
                   -> Int16
                   -> Int16
                   -> Word32
...
foreign import ccall unsafe "arcColor"
    gfxArcColor :: Ptr RendererStruct
                -> Int16
                -> Int16
                -> Int16
                -> Int16
...
foreign import ccall unsafe "aacircleColor"
    gfxAACircleColor :: Ptr RendererStruct
                     -> Int16
                     -> Int16
                     -> Int16
                     -> Word32
...
foreign import ccall unsafe "filledCircleColor"
    gfxFilledCircleColor :: Ptr RendererStruct
                         -> Int16
                         -> Int16
                         -> Int16
                         -> Word32
...
foreign import ccall unsafe "ellipseColor"
    gfxEllipseColor :: Ptr RendererStruct
                    -> Int16
                    -> Int16
                    -> Int16
                    -> Int16
...
foreign import ccall unsafe "aaellipseColor"
    gfxAAEllipseColor :: Ptr RendererStruct
                      -> Int16
                      -> Int16
                      -> Int16
                      -> Int16
...
foreign import ccall unsafe "filledEllipseColor"
    gfxFilledEllipseColor :: Ptr RendererStruct
                          -> Int16
                          -> Int16
                          -> Int16
                          -> Int16
...
foreign import ccall unsafe "pieColor"
    gfxPieColor :: Ptr RendererStruct
                -> Int16
                -> Int16
                -> Int16
                -> Int16
...
foreign import ccall unsafe "filledPieColor"
    gfxFilledPieColor :: Ptr RendererStruct
                      -> Int16
                      -> Int16
                      -> Int16
                      -> Int16
...
foreign import ccall unsafe "trigonColor"
    gfxTrigonColor :: Ptr RendererStruct
                   -> Int16
                   -> Int16
                   -> Int16
                   -> Int16
...
foreign import ccall unsafe "aatrigonColor"
    gfxAATrigonColor :: Ptr RendererStruct
                     -> Int16
                     -> Int16
                     -> Int16
                     -> Int16
...
aaTrigon :: Renderer
         ...
         -> Pixel
         -> IO Bool
aaTrigon renderer x1 y1 x2 y2 x3 y3 (Pixel w) =
    withForeignPtr renderer $ \ptr ->
    intToBool(-1) (fmap fromCInt $ gfxAATrigonColor ptr x1 y1 x2 y2 x3 y3 w)

foreign import ccall unsafe "filledTrigonColor"
    gfxFilledTrigonColor :: Ptr RendererStruct
                         -> Int16
                         -> Int16
                         -> Int16
                         -> Int16
...
filledTrigon :: Renderer
             ...
             -> Pixel
             -> IO Bool
filledTrigon renderer x1 y1 x2 y2 x3 y3 (Pixel w) =
    withForeignPtr renderer $ \ptr ->
    intToBool(-1) (fmap fromCInt $
        gfxFilledTrigonColor ptr x1 y1 x2 y2 x3 y3 w)

foreign import ccall unsafe "polygonColor"
    gfxPolygonColor :: Ptr RendererStruct
                    -> Ptr Int16
                    -> Ptr Int16
                    -> Int
                    -> Word32
...
aaPolygon renderer list (Pixel w) =
    withForeignPtr renderer $ \ptr ->
    withArray (map fst list) $ \xs ->
    withArray (map snd list) $ \ys ->
    intToBool (-1) $ fmap fromCInt $
        gfxAAPolygonColor ptr xs ys (length list) w

foreign import ccall unsafe "filledPolygonColor"
    gfxFilledPolygonColor :: Ptr RendererStruct
                          -> Ptr Int16
                          -> Ptr Int16
                          -> Int
                          -> Word32
...
filledPolygon renderer list (Pixel w) =
    withForeignPtr renderer $ \ptr ->
    withArray (map fst list) $ \xs ->
    withArray (map snd list) $ \ys ->
    intToBool (-1) $ fmap fromCInt $
        gfxFilledPolygonColor ptr xs ys (length list) w

foreign import ccall unsafe "texturedPolygon"
    gfxTexturedPolygon :: Ptr RendererStruct
                       -> Ptr Int16
                       -> Ptr Int16
                       -> Int
                       -> Ptr RendererStruct
...
texturedPolygon :: Renderer
                ...
                -> Int
                -> IO Bool
texturedPolygon renderer list texture dx dy =
    withForeignPtr renderer $ \ptr ->
    withForeignPtr texture $ \txt ->
    withArray (map fst list) $ \xs ->
    withArray (map snd list) $ \ys ->
    intToBool (-1) $ fmap fromCInt $
        gfxTexturedPolygon ptr xs ys (length list) txt dx dy

foreign import ccall unsafe "bezierColor"
    gfxBezierColor :: Ptr RendererStruct
                   -> Ptr Int16
                   -> Ptr Int16
                   -> Int
                   -> Int
...
bezier renderer list steps (Pixel w) =
    withForeignPtr renderer $ \ptr ->
    withArray (map fst list) $ \xs ->
    withArray (map snd list) $ \ys ->
    intToBool (-1) $ fmap fromCInt $
        gfxBezierColor ptr xs ys (length list) steps w
